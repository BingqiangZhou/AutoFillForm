...
- v2：实现循环自动提交表单。
- v3：实现骗过智能验证并提交表单。
- v4：加上日志并开启线程监控退出程序按键。
- v5：加上需要智能验证时自动切换到浏览器问卷标签页以及异常处理。

## 第二版

- v6：支持矩阵单选问题填写
- v7：支持从yaml文件中读取自动填写问卷规则与问卷链接
...
- [selenium问卷xing智能验证、滑块、error - csdn](https://blog.csdn.net/weixin_45895873/article/details/119811094)
- [Webdriver Manager for Python - pypi.org](https://pypi.org/project/webdriver-manager/)
